...
*/
  ...
  LedLimit = map(1024-PotInput, 0, 1023, 0, 8);     // scale it to use it with the servo (value between 0 and 180) 
  ...
  if (LedDirection==1)
  {
    ...
    if (xPin>=LedLimit) { 
      LedDirection = 2; xPin++;
      WalkSpeed = map(PotInput, 0, 1023, 1, 200);     // scale it to use it with the servo (value between 0 and 180) 
    } else
    if (xPin==9) { 
      LedDirection = 2; xPin++; 
      WalkSpeed = map(PotInput, 0, 1023, 1, 200);     // scale it to use it with the servo (value between 0 and 180) 
